...
$form->rowHiddenField($tasks_model, 'name',                   $row_params, 'wide-label');
...
$form->rowDropDownField($tasks_model, 'statusid',Tasks::getStatuses(),$row_params, 'wide-label');
$form->rowROField($tasks_model, 'updated_at',             $row_params, 'wide-label');
